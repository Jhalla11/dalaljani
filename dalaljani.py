#created by dalal jani nick name jhalla
#github= jhalla11
#JAI NEPAL
# fb id https://www.facebook.com/profile.php?id=100012510726200
...
def xerx():
    ...
    elif aryan =='7':os.system("xdg-open https://www.facebook.com/profile.php?id=100012510726200")
    else:
...
def x(uid,pwx,tl):
    ...
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=7uDUY-5S3fBQxgnywD3gph6A; sb=7uDUY2NX6FsFXifrb0cEgONA; m_pixel_ratio=2; dnonce=AWlZ5T82qjr2vpeBJhmCLZSCtHGBCqCwR0vrJT4h90VnJ-0ivgkNy2qjHYqNJKkIg-LHcluajdANGIXuOb0yrw8C; wd=360x680; fr=0bcIipOeje7e6K4Ed..Bj1ODu.pE.AAA.0.0.Bj1OSU.AWWarw7J63g',
    'sec-ch-ua': '"Chromium";v="105", "Not)A;Brand";v="8"',
    'sec-ch-ua-mobile': '?1',
...
def mobile(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=7uDUY-5S3fBQxgnywD3gph6A; sb=7uDUY2NX6FsFXifrb0cEgONA; m_pixel_ratio=2; dnonce=AWlZ5T82qjr2vpeBJhmCLZSCtHGBCqCwR0vrJT4h90VnJ-0ivgkNy2qjHYqNJKkIg-LHcluajdANGIXuOb0yrw8C; wd=360x680; fr=0bcIipOeje7e6K4Ed..Bj1ODu.pE.AAA.0.0.Bj1OJ0.AWVyrDRGe68',
    'sec-ch-ua': '"Chromium";v="105", "Not)A;Brand";v="8"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-platform': '"Android"',
    'sec-fetch-dest': 'document',
...
def freeq(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=7uDUY-5S3fBQxgnywD3gph6A; sb=7uDUY2NX6FsFXifrb0cEgONA; m_pixel_ratio=2; dnonce=AWmmXwTxDVWBhZGrJ-tuDjP6aX-Z-LCRxD4FaugHu95RfqAJTG58vJztWbhiza8QYDKwtL69m4jv2svlBl4xt-Fq; wd=360x680; fr=0bcIipOeje7e6K4Ed..Bj1ODu.pE.AAA.0.0.Bj1OJO.AWVzzac87iY',
    'sec-ch-ua': '"Chromium";v="105", "Not)A;Brand";v="8"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-platform': '"Android"',
    'sec-fetch-dest': 'document',
...
def d(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=7uDUY-5S3fBQxgnywD3gph6A; sb=7uDUY2NX6FsFXifrb0cEgONA; fr=0bcIipOeje7e6K4Ed..Bj1ODu.pE.AAA.0.0.Bj1OD1.AWUS_Yc3yb4',
    'sec-ch-ua': '"Chromium";v="105", "Not)A;Brand";v="8"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-platform': '"Android"',
    'sec-fetch-dest': 'document',
